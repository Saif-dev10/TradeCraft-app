...
const contactInfo = [
  ...
  },
  {
    icon: FaEnvelope,
    title: "Email",
    details: ["info@tradecraft.com", "support@tradecraft.com"],
    color: "bg-blue-500",
  },
  {
    icon: FaClock,
    ...
    <>
      ...
      {/* Hero Section */}
        <section className="relative overflow-hidden py-24 lg:py-32">
          {/* Background Image - Professional Business Handshake */}
          <div
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                  <div className="grid gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-2 block w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition-all duration-200 focus:border-amber-500 focus:bg-white focus:ring-2 focus:ring-amber-500/20"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="mt-2 block w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition-all duration-200 focus:border-amber-500 focus:bg-white focus:ring-2 focus:ring-amber-500/20"
