        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2 md:col-span-1">
              <span className="text-2xl font-bold text-white tracking-tight block mb-4">TradeCraft</span>
              <p className="text-sm leading-relaxed">
                Professional trade journaling for serious traders. Analyze, improve, and profit.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-slate-600">© 2026 TradeCraft. All rights reserved.</p>
